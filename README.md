...
```text
.
├── 📗 Digital_Logics/      # 디지털 논리회로 및 시스템 설계 (Multisim, Proteus, Quartus, VHDL, Simulink)
├── 📘 MicrochipStudio/     # 마이크로컨트롤러 실습 (AVR, C/Assembly CPU 동작 이해)
├── 📙 RaspberryPi/         # 임베디드 시스템 (C, Linux, GPIO, BLE)
├── 🛰️ Adafruit feather.../ # nRF52840 기반 BLE 및 시리얼 통신 예제
├── 💻 VS2019/              # C 언어 기초 및 데이터 처리 실습
├── 🌐 Wokwi/               # 온라인 시뮬레이터 연동 예제 (Arduino Blink)
...
*   **실습 도구별 예제**:
    ...
    *   [Quartus 예제](/Digital_Logics/Quartus_schematics/) : FPGA 기반 논리 회로 설계 (Schematic)
    *   [Proteus 예제](/Digital_Logics/Proteus/) : 마이크로컨트롤러 연동 시뮬레이션
    *   [Simulink 예제](/Digital_Logics/Simulink/) : 모델 기반 설계 및 시뮬레이션
...
*   **목표**: 하드웨어 설계 언어(HDL) 기초 및 응용
*   **실습 내용**: 
    *   [VHDL 예제](/Digital_Logics/VHDL/) : 하드웨어 기술 언어를 이용한 디지털 시스템 설계
...
*   **실습 구성**:
    *   [Wokwi 기반 예제](/Wokwi/Blink/) : 온라인 기반 아두이노 시뮬레이션
    *   [C/Assembly 분석](/MicrochipStudio) : Disassembler를 통한 CPU 동작 원리 이해
    *   [C 언어 복습](/VS2019) : 임베디드 C 기초 다지기 (Visual Studio 2019)
...
*   **주요 플랫폼**: 
    *   [Raspberry Pi 실습](/RaspberryPi) : Linux 기반 C 프로그래밍, 멀티스레드(Semaphore), GPIO 제어
