`timescale 1ns / 1ps
module FNDDisplay(clk, clk100hz, mode, dc_sec, dc_min, dc_hour, tl_mmsec, tl_sec, tl_min, 
					hourFND, minFND, secFND, hourFNDSel2, hourFNDSel1, minFNDSel2, minFNDSel1, 
					secFNDSel2, secFNDSel1);
...
// always for converting to integer
	always @ (mode, dc_hour, dc_min, dc_sec, tl_min, tl_sec, tl_mmsec) begin
		case (mode)
