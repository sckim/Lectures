...
ARCHITECTURE arc OF fig5_62 IS	
	...
	BEGIN
	  ...
	  WITH input SELECT
			x <= '0' WHEN "000", -- x equals 1 when input equals "000"
				 '0' WHEN "001", -- x equals 0 when input equals "001"
			     '0' WHEN "010", -- x equals 1 when input equals "010"
		    	 '1' WHEN "011", -- x equals 0 when input equals "011"
			     '0' WHEN "100", -- x equals 1 when input equals "100"
			     '1' WHEN "101", -- x equals 1 when input equals "101"
			     '1' WHEN "110", -- x equals 1 when input equals "110"
			     '1' WHEN "111", -- x equals 0 when input equals "111"
			     '1' WHEN others;
END arc;