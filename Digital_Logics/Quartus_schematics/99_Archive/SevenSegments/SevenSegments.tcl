...
# File: SevenSegments.tcl
# Generated on: Sat Jan 04 22:56:23 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "SevenSegments"]} {
		puts "Project SevenSegments is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists SevenSegments]} {
		project_open -revision SevenSegments SevenSegments
	} else {
		project_new -revision SevenSegments SevenSegments
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "22:39:07  JANUARY 04, 2025"
	...
	set_global_assignment -name TOP_LEVEL_ENTITY SevenSegments
