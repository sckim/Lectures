...
entity RippleAdder_vhdl is
	port( x, y 			: in std_logic_vector(3 downto 0);
		  seg1, seg2 	: out std_logic_vector(6 downto 0));
end RippleAdder_vhdl;

architecture design of RippleAdder_vhdl is
...
begin
	sum <= (not a and not b and c_in) or (not a and b and not c_in) or (a and not b and not c_in) or (a and b and c_in);
