...
--	signal	state0					: STATE_TYPE;
--	signal	state1					: STATE_TYPE;
--	signal	state2					: STATE_TYPE;
--	signal	state3					: STATE_TYPE;
--	signal	state4					: STATE_TYPE;
--	signal	state5					: STATE_TYPE;
--	signal	state6					: STATE_TYPE;
--	signal	state7					: STATE_TYPE;
--	signal	state8					: STATE_TYPE;
--	signal	state9					: STATE_TYPE;
--	signal	stateA					: STATE_TYPE;
--	signal	stateB					: STATE_TYPE;
--	signal	stateC					: STATE_TYPE;
--	signal	stateD					: STATE_TYPE;
--	signal	stateE					: STATE_TYPE;
--	signal	stateF					: STATE_TYPE;
