...
ARCHITECTURE regs_arch of reg IS
	...
	signal	ar_k						: std_logic_vector(2 downto 0);
	signal	pc_k						: std_logic_vector(2 downto 0);
	signal	dr_k						: std_logic_vector(1 downto 0);
	signal	ac_k						: std_logic_vector(2 downto 0);
		
BEGIN
	ar_k <= ar_ld & ar_inr & ar_clr;
	pc_k <= pc_ld & pc_inr & pc_clr;
	dr_k <= dr_ld & dr_inr;
	ac_k <= ac_ld & ac_inr & ac_clr;
