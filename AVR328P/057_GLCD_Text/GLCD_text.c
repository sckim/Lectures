...
void GLCD_String(char page_no, char *str)/* GLCD string write function */
{
	...
	SetYAddress(0x40);	/* Set Y address (column=0) */
}
...
int main(void) {
	...
	SetSide(LEFT);
	GLCD_String(1,"HKNU Univ.");	/* Print String on 0th page of display */
	SetSide(RIGHT);
	GLCD_String(2,"HKNU Univ.");	/* Print String on 0th page of display */
	while(1);
}
